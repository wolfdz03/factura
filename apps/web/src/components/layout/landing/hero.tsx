  ...
  return (
    <div className="relative flex h-[calc(100svh-64px-150px)] flex-row items-center overflow-hidden border-b border-dashed">
      <div className="absolute inset-0 h-full w-full overflow-hidden">
        <Image
          className="h-full min-h-full w-full object-cover object-left"
      ...
      <div className="z-10 flex flex-col gap-4">
        ...
        <div className="instrument-serif flex flex-col gap-2 px-6 text-6xl">
          <h1 className="text-secondary-foreground/50">
            Créez des factures <span className="text-secondary-foreground">magnifiques</span>
          </h1>
          <h2 className="text-secondary-foreground/50">
            Pas des <span className="text-secondary-foreground">laides</span>
          </h2>
        </div>
        <div className="mt-4 flex flex-row gap-4 px-6">
          ...
          <div className="relative">
            ...
            <span className="jetbrains-mono text-muted-foreground/20 pointer-events-none absolute -top-10 left-40 size-full -rotate-[34deg] text-[10px]">
              Donnez une étoile <br /> s'il vous plaît :3 <br /> pour un cookie
            </span>
